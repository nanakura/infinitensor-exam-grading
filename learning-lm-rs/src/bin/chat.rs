...
mod test {
    ...
    fn test_tokenizer() -> Result<(), Box<dyn std::error::Error>> {
        ...
        assert_eq!(token_ids.to_vec(), vec![32001, 1587, 13, 29383, 28971, 28518, 28998, 28963, 28914, 30278, 29427, 28944, 32000, 28705, 13, 32001, 2188, 13, 29383, 29530, 28924, 30316, 29354, 29354, 30627, 31401, 29797, 29675, 29771, 32000, 28705, 13, 32001, 13892]);
        Ok(())
    }
}
